...
export default function Settings({ premium, child = { name: 'Léa', age: '5 ans' }, onEditProfile, onMonGrabi, onPlayGrabi, onRewards, onEspaceParents, onHome, onCommunity, onCreate, onMine }) {
  return (
